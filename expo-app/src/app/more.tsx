...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'My Enquiries', route: '/enquiries', icon: '\uD83D\uDCAC' },
    ],
  },
  {
    title: 'Store',
...
export default function MoreScreen() {
  ...
  const { count } = useCart();
  const { count: enquiryCount } = useEnquiries();
                ...
                {section.items.map((item, idx) => (
                  <Pressable
                    ...
                    <View style={styles.rowLeft}>
                      ...
                      {'route' in item && item.route === '/enquiries' && enquiryCount > 0 && (
                        <View style={styles.badge}>
                          <ThemedText style={styles.badgeText}>{enquiryCount}</ThemedText>
                        </View>
                      )}
                    </View>
