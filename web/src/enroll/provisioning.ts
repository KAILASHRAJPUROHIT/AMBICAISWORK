...
//
// Deploy-specific values default to the production APK served at /files/agent.apk and can be
// overridden at web-build time:
//   VITE_AGENT_PACKAGE     applicationId of the distributed APK (default com.mdmesh.agent)
...
// Keep these defaults in lockstep with the APK published at /files/agent.apk. A QR component or
// signing-certificate mismatch makes Android abort Device Owner provisioning.
const AGENT_PACKAGE = env.VITE_AGENT_PACKAGE || 'com.mdmesh.agent';
const ADMIN_COMPONENT = `${AGENT_PACKAGE}/com.mdmesh.agent.admin.AdminReceiver`;
const SIGNATURE_CHECKSUM = env.VITE_AGENT_CHECKSUM || 'bhi71a1DsHsio1xr0TIMwBx0PJjy8UlxYbUeLRclQTA';
