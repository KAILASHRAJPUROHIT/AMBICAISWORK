...
:: Define variables
SET "SERVICE_NAME=AmbicSmartQRPrintAgent"
SET "NSSM_EXE=%~dp0nssm.exe"
SET "AGENT_DIR=%~dp0"
SET "PYTHON_EXE=python.exe"

echo ===================================================
echo AMBIC SmartQR Print Agent - NSSM Service Installer
echo ===================================================
echo.
...
:: Set description
"%NSSM_EXE%" set "%SERVICE_NAME%" Description "Background daemon for AMBIC SmartQR. Polls cloud and prints automatically."
