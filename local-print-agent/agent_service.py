...
class PrintAgentService(win32serviceutil.ServiceFramework):
    _svc_name_ = "AmbicSmartQRPrintAgent"
    _svc_display_name_ = "AMBIC SmartQR Print Agent"
    _svc_description_ = "Background service that downloads and prints jobs queued via AMBIC SmartQR."
