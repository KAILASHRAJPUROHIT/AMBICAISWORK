# AIS Owner Console — local legacy runtime

Canonical source copy moved to `C:\AradhanaSystems\platform\ais-owner-console` on 2026-09-07. The active fallback runtime remains under `C:\DEEPSEEK HARNESS\dashboard` until a controlled watchdog cutover is separately verified.

The dashboard currently depends on Cloudflare D1 development bindings and local Windows services. It is not the production cloud gateway; `..\ais-cloud` is the Azure-ready gateway foundation.
