...
const bundledModels: Record<string, number> = {
  'asset:///assets/test-ring.glb': require('@/assets/test-ring.glb'),
  'asset:///assets/test-solitaire.glb': require('@/assets/test-solitaire.glb'),
  'asset:///assets/test-filigree.glb': require('@/assets/test-filigree.glb'),
  'asset:///assets/test-jhumka.glb': require('@/assets/test-jhumka.glb'),
  'asset:///assets/test-bangle-plain.glb': require('@/assets/test-bangle-plain.glb'),
  'asset:///assets/test-bangle-studded.glb': require('@/assets/test-bangle-studded.glb'),
  'asset:///assets/test-pendant.glb': require('@/assets/test-pendant.glb'),
  'asset:///assets/test-necklace.glb': require('@/assets/test-necklace.glb'),
  'asset:///assets/test-bridal-set.glb': require('@/assets/test-bridal-set.glb'),
  'asset:///assets/test-stud-halo.glb': require('@/assets/test-stud-halo.glb'),
};

async function resolveModelUri(source: string): Promise<string> {
  const moduleId = bundledModels[source];
...
export default function JewelleryViewer({
  ...
  const onContextCreate = useCallback(
    (gl: ExpoWebGLRenderingContext) => {
      ...
      if (glbUrl) {
        void resolveModelUri(glbUrl).then((modelUri) => loader.load(
          modelUri,
          (gltf: any) => {
            if (cancelled) {
  ...
  useEffect(() => {
    ...
    const s = sceneRef.current;
    const loader = new GLTFLoader();
    void resolveModelUri(activeVariant.glbUrl).then((modelUri) => loader.load(modelUri, (gltf: any) => {
      if (s.model) {
