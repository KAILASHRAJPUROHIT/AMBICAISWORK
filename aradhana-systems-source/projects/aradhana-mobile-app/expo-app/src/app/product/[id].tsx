            ...
            <View style={[styles.viewerCard, Shadow.md]}>
              ...
              {!viewerLoaded && (
                <View style={styles.viewerLoadingOverlay}>
                  <ThemedText style={styles.viewerLoadingText}>Loading 3D model...</ThemedText>
                </View>
              )}
              {/* Inspect Mode Bar */}
            ...
            <Pressable
              onPress={() => router.push({
                ...
                params: {
                  ...
                  karat: String(effectiveKarat),
                },
              })}
              style={[styles.arBtn, Shadow.sm]}
          ...
          <View style={styles.reviewsSection}>
            <View style={styles.reviewsHeader}>
              ...
              <View style={styles.reviewsSummary}>
                ...
                <ThemedText style={styles.reviewsStar}>{'\u2605'}</ThemedText>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewTop}>
                <View style={styles.reviewAvatar}>
                  <ThemedText style={styles.reviewAvatarText}>R</ThemedText>
                </View>
                <View style={{ flex: 1 }}>
                  <ThemedText style={styles.reviewName}>Rahul M.</ThemedText>
                  <ThemedText style={styles.reviewDate}>Verified Purchase \u2022 2 weeks ago</ThemedText>
                </View>
                <ThemedText style={styles.reviewStars}>{'\u2605\u2605\u2605\u2605\u2605'}</ThemedText>
              </View>
              <ThemedText style={styles.reviewText} numberOfLines={3}>
                Beautiful craftsmanship! The gold quality is excellent and exactly as shown in the 3D viewer.
                Highly recommend Aradhana Jewellers.
              </ThemedText>
            </View>

            <View style={styles.reviewCard}>
              <View style={styles.reviewTop}>
                <View style={[styles.reviewAvatar, { backgroundColor: '#16A34A' }]}>
                  <ThemedText style={styles.reviewAvatarText}>P</ThemedText>
                </View>
                <View style={{ flex: 1 }}>
                  <ThemedText style={styles.reviewName}>Priya S.</ThemedText>
                  <ThemedText style={styles.reviewDate}>Verified Purchase \u2022 1 month ago</ThemedText>
                </View>
                <ThemedText style={styles.reviewStars}>{'\u2605\u2605\u2605\u2605\u2605'}</ThemedText>
              </View>
              <ThemedText style={styles.reviewText} numberOfLines={3}>
                Bought this for my wedding. The BIS 916 hallmark gives me confidence. Staff was very helpful
                and the AR try-on feature helped me choose the perfect ring!
              </ThemedText>
            </View>

            <View style={styles.reviewCard}>
              <View style={styles.reviewTop}>
                <View style={[styles.reviewAvatar, { backgroundColor: '#D97706' }]}>
                  <ThemedText style={styles.reviewAvatarText}>A</ThemedText>
                </View>
                <View style={{ flex: 1 }}>
                  <ThemedText style={styles.reviewName}>Amit K.</ThemedText>
                  <ThemedText style={styles.reviewDate}>Verified Purchase \u2022 3 weeks ago</ThemedText>
                </View>
                <ThemedText style={styles.reviewStars}>{'\u2605\u2605\u2605\u2605\u2606'}</ThemedText>
              </View>
              <ThemedText style={styles.reviewText} numberOfLines={3}>
                Great quality gold jewellery. The online catalog is impressive. Would have liked more
                design options in the everyday wear category.
              </ThemedText>
            </View>

            <Pressable
              onPress={() => {
                const text = encodeURIComponent(`Namaste ${MASTER.displayName}, I would like to share feedback about ${product.label}.`);
                Linking.openURL(`${MASTER.whatsapp}?text=${text}`);
              }}
              style={styles.reviewsWriteBtn}>
              <ThemedText style={styles.reviewsWriteBtnText}>Write a Review</ThemedText>
            </Pressable>
          </View>
...
const styles = StyleSheet.create({
  ...
  viewerLoadingText: { fontSize: 13, fontWeight: '600', color: '#6B7280' },
  ...
  /* Reviews */
  reviewsSection: { marginHorizontal: 16, gap: 12 },
  reviewsHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  reviewsTitle: { fontSize: 18, fontWeight: '700', color: '#1A1A2E' },
  reviewsSummary: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  reviewsRating: { fontSize: 16, fontWeight: '700', color: '#C9A84C' },
  reviewsStar: { fontSize: 14, color: '#C9A84C' },
  reviewsCount: { fontSize: 12, color: '#6B7280' },

  reviewCard: {
    backgroundColor: '#FFFFFF', borderRadius: BorderRadius.lg, padding: 14,
    borderWidth: 1, borderColor: '#E5E1D8', gap: 10,
  },
  reviewTop: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  reviewAvatar: {
    width: 36, height: 36, borderRadius: 18, backgroundColor: '#23519D',
    alignItems: 'center', justifyContent: 'center',
  },
  reviewAvatarText: { fontSize: 14, fontWeight: '700', color: '#FFFFFF' },
  reviewName: { fontSize: 13, fontWeight: '600', color: '#1A1A2E' },
  reviewDate: { fontSize: 10, color: '#9CA3AF', marginTop: 1 },
  reviewStars: { fontSize: 12, color: '#C9A84C' },
  reviewText: { fontSize: 13, color: '#6B7280', lineHeight: 18 },

  reviewsWriteBtn: {
    backgroundColor: '#F8F6F3', borderRadius: BorderRadius.md, paddingVertical: 12,
    alignItems: 'center', borderWidth: 1, borderColor: '#E5E1D8',
  },
  reviewsWriteBtnText: { fontSize: 13, fontWeight: '600', color: '#1A1A2E' },
